        ...
        >
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Grid container spacing={{ xs: 1, sm: 2, md: 3 }} height="100%">
              {/* Total Trainee */}
              <Grid item xs={12} sm={6} sx={{ height: 'auto' }} mb={4}> {/* Changed md={12} to sm={6}, ensure height auto or adjust */}
                <Paper
                  sx={{
              ...
              {/* Calendar */}
              {/* Calendar takes full width within this column, so no changes needed here for 2-per-row */}
              <Grid item xs={12}>
          ...
          <Grid item xs={12} lg={4}>
            <Grid container spacing={{ xs: 1, sm: 2, md: 3 }}>
              {/* Active Trainee */}
              <Grid item xs={12} sm={6} sx={{ height: 'auto' }} mb={4}> {/* Changed md={6} lg={12} to sm={6} */}
                <Paper
                  sx={{
                    p: { xs: 1.5, sm: 2, md: 2.5 },
                    height: '100%', // Ensure paper takes full height of grid item
              ...
              <Grid item xs={12} sm={6} sx={{ height: 'auto' }} mb={4}> {/* Changed md={6} lg={12} to sm={6} */}
                <Paper
                  sx={{
                    ...
                    flexDirection: "column", // Keep flex for internal layout
                    transition: 'transform 0.2s ease-in-out, box-shadow 0.2s ease-in-out',
                    '&:hover': {
                      transform: 'scale(1.02)',
                      boxShadow: 6
              ...
              {/* Recent Review */}
              {/* Review takes full width within this column, so no changes needed here for 2-per-row */}
              <Grid item xs={12}>
                <Paper
                  sx={{
                    p: { xs: 1.5, sm: 2, md: 2.5 },
